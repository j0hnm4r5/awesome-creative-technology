...
const list: List = [
  {
    ...
    rows: {
      RadicalMedia: {
        keywords:
          "acommercials, documentaries, music videos, branded experiences, & immersive environments",
      ...
      Acrylicize: {
        keywords:
          "harness the power of art and creativity to help people fall in love with spaces",
      ...
      "Adirondack Studios": {
        keywords:
          "concept, schematic, design, construction, fabrication, installation, support",
      ...
      "Neon Global": {
        keywords:
          "world class and epic experiences that are innovative, creative and exciting",
      ...
      "Beaudry Interactive": {
        keywords:
          "themed entertainment, museum exhibitions, live shows, and branded experiences",
      ...
      Blublu: {
        keywords:
          "projection mapping, immersive experiences for museums and workspace",
        link: "http://www.blu-blu.com/",
        locations: ["Hangzhou"],
      },
      Bluecadet: {
        keywords:
          "experience design across digital and physical environments, visitor centers",
      ...
      Charcoalblue: {
        keywords:
          "amazing spaces where stories are told and experiences are shared",
      ...
      Comuzi: {
        keywords:
          "explore and imagine and prototyp and creatr future-forward creative concepts",
      ...
      "Dimensional Innovations": {
        keywords:
          "experience design, interactive experiences, brand activation",
      ...
      "ESI Design": {
        keywords:
          "transforms places into experiences, immersive deisgn, architectural scale",
        link: "https://esidesign.nbbj.com/",
        locations: ["NYC"],
      },
      Eness: {
        keywords:
          "evocative interactive experiences for public, commercial and cultural entities",
        link: "https://www.eness.com/",
        locations: ["Melbourne"],
      },
      Envoy: {
        keywords:
          "transform environments into exceptional experiences, formerly Leviathan",
      ...
      Float4: {
        keywords:
          "integrates digital experiences into physical spaces to amplify their identity",
        link: "https://float4.com/en/",
        locations: ["Montreal", "NYC"],
      },
      "Future Colossal": {
        keywords:
          "experiential technologies in advertising and entertainment and art",
      ...
      "Giant Spoon": {
        keywords:
          "translate cultural trends into big ideas, experiential, gaming",
        link: "https://giantspoon.com/",
        locations: ["NYC", "LA"],
      },
      "Hettema Group": {
        keywords:
          "experiential, exhibit, live shows, theme parks, retail, dining, museums",
      ...
      Hovercraft: {
        keywords:
          "interactive installations, site-specific content, retail, sports",
      ...
      "IMG SRC": {
        keywords:
          "full-service communication agency focusing on websites, installations, and R&D",
        link: "https://www.imgsrc.co.jp/",
        locations: ["Tokyo"],
      },
      "Immersive International": {
        keywords:
          "live experiences and art installations in public, private and commercial spaces",
      ...
      "Invisible North": {
        keywords:
          "culturally fluent, thoughtful experiences, bring brands to life",
      ...
      "Left Field Labs": {
        keywords:
          "products, platforms, and services that solve fundamental human challenges",
        link: "https://www.leftfieldlabs.com/",
        locations: ["LA"],
      },
      Listen: {
        keywords:
          "sensory-driven brand assets, modern cultural landscape, sound, experiences",
        link: "https://wearelisten.com/",
        locations: ["NYC"],
      },
      "Lorem Ipsum": {
        keywords:
          "experience design, narrative, physical and digital environments",
        link: "https://loremipsumcorp.com/",
        locations: ["NYC", "Moscow", "London"],
      },
      MSCHF: {
        keywords:
          "viral stunts and products, trying to do stuff that the world can't even define",
        link: "https://mschf.xyz/",
        locations: ["NYC"],
      },
      Magnopus: {
        keywords:
          "unite the physical and digital worlds with extraordinary experiences",
      ...
      Map: {
        keywords:
          "industrial designers who believe great design can solve problems",
        link: "http://mapprojectoffice.com/",
        locations: ["London"],
      },
      "Marshmallow Laser Feast": {
        keywords:
          "leaving a slug trail of sensory nuggets as we journey through the cosmos",
      ...
      "NEXT/NOW": {
        keywords:
          "brand activations, immersive environments, emerging technologies",
        link: "https://www.nextnowagency.com/",
        locations: ["Chicago"],
      },
      "NGX Interactive": {
        keywords:
          "pushing new technologies to create experiences that are vivid and meaningful",
      ...
      "Night Kitchen": {
        keywords:
          "dynamic digital experiences, online exhibitions, digital strategy, storytelling",
        link: "https://www.whatscookin.com/",
        locations: ["Philadelphia"],
      },
      Nohlab: {
        keywords:
          "producing interdisciplinary experiences around art, design and technology",
        link: "https://nohlab.com/works",
        locations: ["Istanbul"],
      },
      Normal: {
        keywords:
          "public installations, entertainment, performing arts, stage design",
      ...
      OIO: {
        keywords:
          "creative company working on future products and tools for a less boring future",
        link: "https://oio.studio/",
        locations: ["London"],
      },
      "Oat Foundry": {
        keywords:
          "split-flap displays, electromechanical stuff, think tank, products, experiences",
      ...
      "Patten Studio": {
        keywords:
          "informed by research at the MIT Media Lab, experiences that connect people",
      ...
      "Relative Scale": {
        keywords:
          "bespoke digital products and experiences for brands and institutions",
      ...
      "Second Story": {
        keywords:
          "exhibition, interactive, software, experience, hardware, VR, AR, projection",
      ...
      Spectacle: {
        keywords:
          "expertise in fabricating experiences that drive engagement and wow participants",
        link: "https://spectacle.works/",
        locations: ["Phoenix"],
      },
      "Spectra Studio": {
        keywords:
          "installations, projection, sculpture, robotics, light and sound",
      ...
      "Studio Black": {
        keywords:
          "technical production, design advisory, content management, digital content",
      ...
      "Super A-OK": {
        keywords:
          "A multi-modal service bureau for the 21st century, fabrication, electronics",
        link: "https://superaok.com/",
        locations: ["NYC"],
      },
      Superfly: {
        keywords:
          "create shared experiences that shape how the world plays & connects",
        link: "https://superf.ly/",
        locations: ["NYC"],
      },
      TAD: {
        keywords:
          "digital experiences, technology and architecture, designed to inspire people.",
      ...
      "The Lab at Rockwell Group": {
        keywords:
          "architecture and design, branded experiences, immersive environments, pop ups",
      ...
      "Yellow Studio": {
        keywords:
          "artistically-minded design, tv/concert/event production design, set design",
        link: "https://yellowstudio.com/",
        locations: ["NYC"],
      },
      dotdotdash: {
        keywords:
          "innovation agency that seamlessly blends the physical and digital",
  ...
  },
  {
    ...
    rows: {
      ...
      "Dave + Gabe": {
        keywords:
          "interactive installation studio, real-time animation, generative 3D sound",
        link: "https://www.daveandgabe.care/",
        locations: ["NYC"],
      },
      Hypersonic: {
        keywords:
          "groundbreaking new media sculptures and physical installations",
        link: "https://www.hypersonic.cc/",
        locations: ["NYC"],
      },
      "NONOTAK Studio": {
        keywords:
          "light and sound installations, ethereal, immersive, dreamlike",
      ...
      WHYIXD: {
        keywords:
          "cross-disciplinary art installations, dance, architecture, music",
        link: "https://www.whyixd.com/",
        locations: ["Taiwan"],
      },
      Zebradog: {
        keywords:
          "communication design and the built environment, higher education",
  ...
  },
  {
    ...
    rows: {
      ...
      "Visionary Effects": {
        keywords:
          "old-school manufacturing processes with digital design and fabrication",
  ...
  },
  {
    ...
    rows: {
      ...
      SAT: {
        keywords:
          "immersive experiences, concerts, workshops, conferences, exhibitions",
  ...
  },
  {
    ...
    rows: {
      "Carlo Ratti Associatti": {
        keywords:
          "design and innovation office, MIT Media Lab: Senseable City Lab",
  ...
  },
  {
    ...
    rows: {
      "&Walsh": {
        keywords:
          "brand strategy, art direction, design and production across all platforms",
      ...
      SuperUber: {
        keywords:
          "experiences that blend art, technology, architecture and design",
  ...
  },
  {
    ...
    rows: {
      ...
      Gagarin: {
        keywords:
          "weaving education, information and data into compelling stories",
        link: "https://gagarin.is/",
        locations: ["Reykjavík"],
      },
      Ideum: {
        keywords:
          "interactive exhibits and exhibitions, integrated hardware products",
      ...
      "Local Projects": {
        keywords:
          "experience Designers pushing the boundaries of human interaction",
        link: "https://localprojects.com/",
        locations: ["NYC"],
      },
      "Monadnock Media": {
        keywords:
          "multimedia experiences for museums, historic sites and public places",
        link: "https://monadnock.org/",
        locations: ["Massachusetts"],
      },
      "Northern Light Productions": {
        keywords:
          "immersive media environments, interactive experiences, or documentary films.",
      ...
      Thinc: {
        keywords:
          "provoke meaningful conversations about the world in which we live",
  ...
  },
  {
    ...
    rows: {
      ...
      ISEA: {
        keywords:
          "the crossroads where art, design, science, technology and society meet",
  ...
  },
  {
    ...
    rows: {
      ...
      "University of the Arts": {
        keywords:
          "computational technologies in the context of creative computing research",
